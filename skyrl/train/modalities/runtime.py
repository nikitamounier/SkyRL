...
from skyrl.train.dataset.modalities import ModalitySpec, normalize_modalities_config
from skyrl.train.modalities.batching import ModalityBatch, ModalityOccurrence
from skyrl.train.modalities.handlers import (
    ModalityEncoderProtocol,
    ModalityProjectorProtocol,
    ensure_sequence_of_tensors,
)
from skyrl.train.modalities.loader import instantiate_handler
from skyrl.train.modalities.types import SampleModalityData
...
class ModalitiesManager:
    ...
    def ensure_embedding_spans(
        ...
        """
        from skyrl.train.dataset.modalities import ModalityEmbeddingSpan, collect_embedding_spans
